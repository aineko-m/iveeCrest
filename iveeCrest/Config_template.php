...
class Config
{
    ...
    protected static $clientId           = 'myClientId';
    protected static $clientSecret       = 'myClientSecret';
    protected static $clientRefreshToken = 'myCharRefreshToken';

    //change the application name in the parenthesis to your application. It is used when accessing the CREST API.
    protected static $userAgent = 'iveeCrest/0.1 (unknown application)';
    ...
    protected static $classes = array(
        'Cache'                 => '\iveeCrest\MemcachedWrapper', //change to '\iveeCrest\RedisWrapper' if using Redis
